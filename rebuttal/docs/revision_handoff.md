...
5. Insert `runs/figures/2d_galilean_n64_id_ood_fields.pdf` immediately after the
   headline N64 table and before the label-efficiency subsection.
...
figure specification and plotting script, and all four paper-facing figure
families. Generated PDE tensors may be omitted because their checked-in configs
recreate them; the preserved rMD17 tensor is the documented exception.
